...
namespace ZECS.Schedule.Algorithm.Utilities
{
    ...
    public sealed class OracleHelper
    {
        ...
        //private static bool bShowed = false;
        ...
        public static void ShowErrorMessage(Exception ex)
        {
            ...
            //    System.Windows.Forms.MessageBox.Show(oex.ErrorCode + "\n" + oex.Message + "\n" + oex.StackTrace,
            //    "数据库错误，"+oex.Code,System.Windows.Forms.MessageBoxButtons.OK,System.Windows.Forms.MessageBoxIcon.Error);
            //}
            //else if (!bShowed)
            //{
            //    System.Windows.Forms.MessageBox.Show(ex.Message, "数据库错误！", System.Windows.Forms.MessageBoxButtons.OK, System.Windows.Forms.MessageBoxIcon.Error);
            //    bShowed = true;
            //}
        }
