...
{
    public class ASC_ReqUpdateJob : DBClass_BASE
    {
        ...
        public override void Copy(DBClass_BASE other)
        {
            if (other == null)
                return;
            ASC_ReqUpdateJob updateJob = other as ASC_ReqUpdateJob;
            base.Copy(updateJob);
            ...
            this.FROMPALLETTYPE = updateJob.FROMPALLETTYPE;//1
            ...
            this.FROM_RFID = updateJob.FROM_RFID;//2
            this.TOPALLETTYPE = updateJob.TOPALLETTYPE;//3
            this.TO_RFID = updateJob.TO_RFID;//4
            this.OPERATOR_ID = updateJob.OPERATOR_ID;//5
