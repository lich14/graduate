...
{
    [Serializable]
    public class ASC_ResJob : DBClass_BASE
    {
        ...
        public virtual string FROMPALLETTYPE { get; set; }
        ...
        public virtual string TOPALLETTYPE { get; set; }
        ...
        public override void Copy(DBClass_BASE other)
        {
            if (other == null)
                return;
            ASC_ResJob resJob = other as ASC_ResJob;
            base.Copy(resJob);
            ...
            this.TOPALLETTYPE = resJob.TOPALLETTYPE;//3
            this.TO_TRUCK_POS = resJob.TO_TRUCK_POS;
            this.TO_RFID = resJob.TO_RFID;//4
            ...
            this.OPERATOR_ID = resJob.OPERATOR_ID;//5
            this.ORDER_ASSIGNER = resJob.ORDER_ASSIGNER;//6
            ...
            try
            {
                switch (strPropertyName)
                {
                    ...
                    case "DATETIME":
                        ...
                        break;
                    case "FROMPALLETTYPE":
                        FROMPALLETTYPE = Convert.ToString(propertyValue);
                        break;
                    case "TOPALLETTYPE":
                        TOPALLETTYPE = Convert.ToString(propertyValue);
                        break;
                    case "TO_RFID":
