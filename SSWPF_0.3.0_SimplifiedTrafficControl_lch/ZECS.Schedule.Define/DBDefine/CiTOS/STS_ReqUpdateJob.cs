...
{
    [Serializable]
    public class STS_ReqUpdateJob : DBClass_BASE
    {
        ...
        public override void Copy(DBClass_BASE other)
        {
            if (other == null)
                return;
            STS_ReqUpdateJob updateJob = other as STS_ReqUpdateJob;
            base.Copy(updateJob);
            ...
            this.CHE_TYPE = updateJob.CHE_TYPE;//1
            ...
            this.VESSEL_ID = updateJob.VESSEL_ID;//2
            this.FROM_RFID = updateJob.FROM_RFID;//3
            ...
            try
            {
                switch (strPropertyName)
                {
                    ...
                    case "TO_RFID":
                        ...
                        break;
                    case "CHE_TYPE":
                        CHE_TYPE = Convert.ToString(propertyValue);
                        break;
                }
