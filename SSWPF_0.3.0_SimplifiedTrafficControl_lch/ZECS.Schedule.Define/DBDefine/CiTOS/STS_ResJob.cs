...
{
    [Serializable]
    public class STS_ResJob : DBClass_BASE
    {
        ...
        public override void Copy(DBClass_BASE other)
        {
            if (other == null)
                return;
            STS_ResJob resJob = other as STS_ResJob;
            base.Copy(resJob);
            ...
            this.PLATFORM_CONFIRM = resJob.PLATFORM_CONFIRM;//2
            ...
            this.VESSEL_ID = resJob.VESSEL_ID;//3
            this.FROM_RFID = resJob.FROM_RFID;//4
